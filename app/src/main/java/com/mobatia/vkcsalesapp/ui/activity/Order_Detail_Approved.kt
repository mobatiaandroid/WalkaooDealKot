...
class Order_Detail_Approved() : AppCompatActivity(), VKCUrlConstants, VKCDbConstants,
    ...
    private fun initUi() {
        ...
        toast = CustomToast(this@Order_Detail_Approved)
    ...
    private fun getSalesOrderDetails(ordrNo: String) {
        ...
        manager.getResponsePOST(this, name, values, object : ResponseListener {
            ...
            override fun responseFailure(failureResponse: String?) {
                showtoast(this@Order_Detail_Approved, 17)
                isError = true
            }
        })
    }
    ...
    private fun parseResponse(result: String) {
        try {
            ...
            if ((status == "Success")) {
                ...
                val mSalesAdapter = PendingOrderAdapterApproved(
                    this@Order_Detail_Approved, (listPendingOrder)!!
                )
