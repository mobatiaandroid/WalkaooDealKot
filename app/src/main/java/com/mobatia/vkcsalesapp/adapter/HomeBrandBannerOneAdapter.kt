...
class HomeBrandBannerOneAdapter(
    mActivity: Activity,
    brandBannerModels: ArrayList<BrandBannerModel> /*
														 * , DisplayView
														 * displayView
														 */
) : PagerAdapter() {
    ...
    private fun setViews(view: View?, arg0: Int) {
        ...
        VKCUtils.setImageFromUrl(
            mActivity, brandBannerModels[arg0]
                .brandBannerOne?.replace(" ", "%20"), wraperClass.imageBanner, wraperClass
                .progressBar
        )
