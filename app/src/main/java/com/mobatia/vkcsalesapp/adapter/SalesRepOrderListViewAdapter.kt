 ...
 * Bibin
 */
class SalesRepOrderListViewAdapter : BaseAdapter {
    var mActivity: Activity
    var dealersModels: ArrayList<SalesRepOrderModel>
    var mLayoutInflater: LayoutInflater

    constructor(
        dealersModels: ArrayList<SalesRepOrderModel>, mActivity: AppCompatActivity
    ) {
    ...
    constructor(
        dealersModels: ArrayList<SalesRepOrderModel>, mActivity: Activity
    ) {
        this.dealersModels = dealersModels
        this.mActivity = mActivity
        mLayoutInflater = LayoutInflater.from(mActivity)
    ...
    public override fun getView(position: Int, convertView: View, parent: ViewGroup): View {
        ...
        if (convertView == null) {
            view = mLayoutInflater.inflate(
                R.layout.custom_salesrep_list_view,
                null
            )
        } else {
            view = convertView
        ...
        wraperClass.orderNoText.setText(
            "Order Number : " + dealersModels.get(position).getmOrderNo()
        )
        wraperClass.productName
            .setText(
                (
                        "Product Name : "
