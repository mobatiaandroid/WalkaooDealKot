...
class HomeImageBannerAdapter : PagerAdapter {
    ...
    override fun getCount(): Int {
        return mFeedbackFormModels.size
    }
    ...
    internal inner class WraperClassFooter constructor(var view: View) {
        val footerImage1: ImageView
            get() {
                ...
                images1.setScaleType(ImageView.ScaleType.CENTER_CROP)
                return images1
            }
        ...
        val progressBar3: ProgressBar
            get() {
                return view.findViewById<View>(R.id.progressBar3) as ProgressBar
            }
    }
    ...
    private fun setViews(view: View?, arg0: Int) {
        ...
        VKCUtils.setImageFromUrl(
            mActivity,
            mFeedbackFormModels.get(arg0)
                .getBannerUrl() /* "http://dev.mobatia.com/vkc/media/uploads/slider_images/1.jpg" */,
